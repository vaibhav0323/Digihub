...
const SignUp = () => {
  const signupForm = useFormik({
    ...
    onSubmit: async(values, { setSubmitting }) => {
      console.log(values);
      const response = await fetch("http://localhost:5000/api/users/signup", {method:'POST', body: JSON.stringify(values),
       headers: {
        ...
        <div className="card text-black my-5" style={{ borderRadius: 25}}>
          <div className="card-body p-md-5">
            <div className="row justify-content-center">
                ...
                <form className="mx-1 mx-md-4" onSubmit={signupForm.handleSubmit}>
                  <div className="d-flex flex-row align-items-center mb-4">
                    ...
                    <div className="flex-fill mb-0 ">
                       ...
                       id='name' value={signupForm.values.name} 
                  ...
                  <div className="d-flex flex-row align-items-center mb-4">
                    ...
                    <div className="flex-fill mb-0 ">
                      ...
                      type='phone' 
                      className='form-control' 
                      id='phone' value={signupForm.values.phone} 
                      onChange={signupForm.handleChange}/>
                    </div>
                  </div>
                  ...
                  <div className="form-check d-flex justify-content-center mb-5">
                    <input
                      ...
                      id="form2Example3c"
                    />
                    <label className="form-check-label lab4" htmlFor="form2Example3">
              ...
              <img className='mt-5' src='/images/sign2.png' height={400} alt="Logo" /> 
              <h3>The Power of Proof: Display Your Credentials Digitally.</h3>
              </div>
            </div>
          </div>
        </div>
