  ...
  <div className="container-fluid" id="main">
    <div className="row row-offcanvas row-offcanvas-left">
      ...
      <div className="col main pt-5 mt-3">
        <h1 className="display-4 d-none d-sm-block">Bootstrap 4 Dashboard</h1>
        ...
        <p className="lead mt-5">
          Are you ready for Bootstap 4? It's the 4th generation of this popular
          responsive framework. Bootstrap 4 will include some interesting new
          features such as flexbox, 5 grid sizes (now including xl), cards, `em`
          sizing, CSS normalization (reboot) and larger font sizes.
        </p>
          ...
          <div className="col-lg-3 col-md-4">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  Flexbox provides simpler, more flexible layout options like
                  vertical centering.
                </p>
            ...
            <div className="card card-inverse bg-inverse mt-3">
              <div className="card-body">
                ...
                <p className="card-text">
                  Flexbox is now the default, and Bootstrap 4 supports SASS out
                  of the box.
                </p>
            ...
            <div className="card-body">
              <ul className="list-unstyled">
                ...
                <li className="text-uppercase">
                  <code className="text-lowercase">text-uppercase</code>{" "}
                  Uppercase text
                </li>
    ...
    <div className="modal-dialog" role="document">
      <div className="modal-content">
        ...
        <div className="modal-body">
          <p>
            This is a dashboard layout for Bootstrap 4. This is an example of
            the Modal component which you can use to show content. Any content
            can be placed inside the modal and it can use the Bootstrap grid
            classes.
          </p>
          <p>
